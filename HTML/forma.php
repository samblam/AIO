...
<html lang="en">
    <head>  
        ...
        <!-- this adds a new student row when the button is clicked -->
        <script>
            function add_Student() {
                document.getElementById('students').innerHTML += '<div class="row"><label class="col-sm-3"></label><div class="col-sm-8"><div class="input-group"><span class="input-group-addon">Student Name</span><input type="text" class="form-control" aria-label="Name"><span class="input-group-addon">Banner Number</span><input type="text" class="form-control" aria-label="B00"></div></div></div>';
            }
        </script>
    </head>
    <!-- original header. delete when replaced with standardized header -->
    <header class="container">
        <!-- buttons for back and login-->
        <button type="button" class="btn btn-default col-sm-2 ">Back</button>
        <div class="col-sm-8"></div>
        <button type="button" class="btn btn-default col-sm-2">Logout</button>
    </header>
